...
<body>
  <div class="wrapper">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
          <form method="post" action="posttesttime.php" autocomplete="off">
           
            <div class="row mar0 pad10">
              <h5 class="headtxt">Add Test Time Details             
              </h5>
              ...
              <div class="col-sm-4">
                <div class="">
                  ...
                  <select class="form-control inputstyle" name="testtype"  required>
                        <option disabled selected value="">Select Test Type</option>
              ...
              <div class="col-sm-4">
                    ...
                    <input type="number"  min="1" max="180" class="form-control inputstyle" name="questions" required />
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="">
                    <label>CutOff</label>
                    <input type="number"  class="form-control inputstyle" name="cutoff" required />
                    </div>
                </div>         
            ...
            <div class="row mar0 pad10">
              <div class="col-sm-4">
                    ...
                    <input type="number"  min="10" max="180" class="form-control inputstyle" name="time" required />
                    </div>
                </div>               
            </div>
            ...
            <div class="row mar0 pad10">
              <div class="text-right">
                <button type="submit" name="testtimeaddbtn" class="submitbtn">              
                    Submit
                </button>
              </div>              
            </div>
          ...
          <div class="row mar0 pad10">
            <div class="table-responsive pad10 whitebg">
              <h5 class="headtxt">Test Time Details</h5>
              <table id="testtimetable" class="table table-bordered table-condensed">
                <thead>
                  <tr>						
                    <th>Sno</th>
                    <th>Test Type</th>
              ...
              <h5 class="instuctiontxt">*** Click Table Row for  Update Details</h5>
            </div>
          </div>
