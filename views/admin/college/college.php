  ...
  <div class="wrapper">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
        ...
        <li class="active">
          <a href="college.php"><i class="far fa-building"></i>
            College</a>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
          <form method="post" action="postcollegedetails.php" autocomplete="off">
            <div class="row mar0 pad10">
              <h5 class="headtxt">Add College Details</h5>
                <div class="col-sm-4">
                    <div class="">
                      <label>College ID</label>
                      <input type="text" class="form-control inputstyle" name="collegeid" required />
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="">
                      <label>College Name</label>
                      <input type="text" class="form-control inputstyle" name="collegename" required />
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="">
                      <label>Interview Date</label>
                      <input type="text" class="form-control inputstyle datepicker" name="interviewdate" required />
                    </div>
                </div>
            </div>
            <div class="row mar0 pad10">
              <div class="text-right">
                <button type="submit" name="collegeaddbtn" class="submitbtn">              
                    Submit
                </button>
              </div>
          ...
          <div class="row mar0 pad10">
            <div class="table-responsive pad10 whitebg">
              <h5 class="headtxt">College Details</h5>
              <table id="collegetable" class="table table-bordered table-condensed">
                <thead>
                  <tr>						
                    <th>Sno</th>
                    <th>College ID</th>
